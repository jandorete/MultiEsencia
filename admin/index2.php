                            ...
                            <div class="row grupo-noticias">
                                <div class="col-lg-8 col-lg-push-4 col-xs-12">
                                    <article>
                                        ...
                                        <a href="post.php"><img src="http://placehold.it/820x470" class="img-responsive destacada center-block"></a>
                                    </article>
                                </div>
                                <div style="padding: 0px;" class="col-lg-4 col-lg-pull-8 col-xs-12">
                                    <article class="col-lg-12 col-sm-6 col-xs-12">
                                        ...
                                        <a href="post.php"><img src="http://placehold.it/820x470" class="img-responsive img-noticia"></a>
                                    </article>
                                    <article class="col-lg-12 col-sm-6 col-xs-12">
                                        <header><h2 class="titular"><a href="post.php">Lorem ipsum dolor sit amet</a></h2></header>
