        ...
        <?php include 'header.php'; ?>
				...
				<div class="row">
					...
					<div class="container bootstrap snippet">
						<div class="row">
							<div class="col-sm-10"><h1 style="font-size:32px;" >Antonio Serna</h1></div>
							<div class="col-sm-2"><a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="http://www.placecage.com/70/70"></a></div>
						</div>
						<div class="row">
							...
							<div class="col-sm-9">
							  ...
							  <ul class="nav nav-tabs" id="myTab">
								...
								<li><a href="#settings" data-toggle="tab">Configurar perfil</a></li>
							  </ul>
							  ...
							  <div class="tab-content">
								<div class="tab-pane active" id="home">
								 ...
								 <div class="tab-pane" id="messages">
								   ...
								   <ul class="list-group">
									  <li class="list-group-item text-muted">Comentarios</li>
									  <li class="list-group-item text-right"><a href="#" class="pull-left">Dios este articulo esta guapísimo mis dies..</a> 2.13.2014</li>
									  ...
									  <form class="form" action="##" method="post" id="registrationForm">
										  ...
										  <div class="form-group">
											  ...
											  <div class="col-xs-6">
												  ...
												  <input type="text" class="form-control" name="phone" id="phone" placeholder="Introduce el número de telefono" title="enter your phone number if any.">
											  </div>
										  </div>
										  ...
										  <div class="form-group">
											  <div class="col-xs-6">
												 <label for="mobile"><h4>Mobile</h4></label>
												  <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Introduce el número de movil" title="enter your mobile number if any.">
											  </div>
										  </div>
										  <div class="form-group">
											  ...
											  <div class="col-xs-6">
												  ...
												  <input type="email" class="form-control" name="email" id="email" placeholder="nombre@multiesencia.com" title="Introduce tu email.">
											  </div>
										  </div>
										  <div class="form-group">
